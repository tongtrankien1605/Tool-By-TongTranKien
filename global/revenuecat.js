...
// =========    固定部分  ========= //
// =========  @ttk35 ========= //
var hihi = $request.headers["User-Agent"] || $request.headers["user-agent"],
    obj = JSON.parse($response.body);
obj.Attention = "恭喜你抓到元数据！由墨鱼分享，请勿售卖或分享他人！";
var tongtrankien2004 = {
        is_sandbox: !1,
    ...
    ttk35 = { grace_period_expires_date: null, purchase_date: "2022-09-08T01:04:17Z", product_identifier: "com.tongtrankien2004.premium.yearly", expires_date: "2099-12-18T01:04:17Z" };
const match = Object.keys(mapping).find((e) => hihi.includes(e));
if (match) {
    let [e, s] = mapping[match];
    s ? ((ttk35.product_identifier = s), (obj.subscriber.subscriptions[s] = tongtrankien2004)) : (obj.subscriber.subscriptions["com.tongtrankien2004.premium.yearly"] = tongtrankien2004),
        (obj.subscriber.entitlements[e] = ttk35);
} else (obj.subscriber.subscriptions["com.tongtrankien2004.premium.yearly"] = tongtrankien2004), (obj.subscriber.entitlements.pro = ttk35);
